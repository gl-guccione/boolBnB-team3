...
class ViewController extends Controller
{
    ...
    public function show($slug)
    {
      ...
      $total_views = View::whereHas('flat', function ($query) use($slug) {
      ...
      $today_views = View::where('date', '>', $today)->whereHas('flat', function ($query) use($slug) {
        $query->where([
                        ['user_id', Auth::id()],
                        ['slug', $slug]
                      ]);
      ...
      $one_day_before_views = View::where([
                                            ['date', '>', $oneDayBefore],
                                            ['date', '<', $today]
                                          ])->whereHas('flat', function ($query) use($slug) {
        $query->where([
                        ['user_id', Auth::id()],
                        ['slug', $slug]
                      ]);
